...
{
    public class DirectoryMoveIntegrationTests
    {
        [Test]
        public async Task TestDirectoryMoveEndpoint()
        {
            ...
            var response = await context.Client.PostAsync("/directory-move", content);
