...
namespace DynamicApiServer.Tests.Integration.Endpoints.Files
{
    public class FilePrependIntegrationTests
    {
        ...
        public async Task TestFilePrependEndpoint()
        {
            ...
            var response = await context.Client.PostAsync($"/file-prepend", new StringContent("{ \"workingDirectory\": \"" + workingDirectory + "\", \"file-path\": \"" + filePath + "\", \"content\": \"" + contentToPrepend + "\", \"add-newline\": \"false\" }", Encoding.UTF8, "application/json"));
